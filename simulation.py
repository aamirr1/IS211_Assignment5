...
if __name__ == '__main__':
    ...
    Question: After running both simulations, what are the results do you see?
    How does each simulation differ in its average latency?
    
    Answer: After running both simulations, we noticed that the wait time depends on the amount of servers.
    Sometimes it's bigger or longer and sometimes it is smaller or shorte.
    """
